...
function Navigation() {
  ...
  const open = useSearch((store) => store.onOpen);
    ...
    <>
      ...
      >
        <div
          ...
          onClick={collapse}
          className={cn(
            "w-6 h-6 absolute top-3 right-2 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 opacity-0 group-hover/sidebar:opacity-100 transition",
